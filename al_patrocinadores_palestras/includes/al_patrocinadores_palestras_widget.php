<?php
// Que tipo de ação e      // Qual função deve ser chamada
add_action('widgets_init', 'al_pat_pal_registra_widget'); // Registando a ação
function al_pat_pal_registra_widget()
{
    register_widget('PatrocinadoresAlura');// Registrando a class
}
...
class PatrocinadoresAlura extends WP_Widget
{
    ...
    // Deve return um array
    public function update($new_instance, $old_instance)
    {
        $instance = array();                                    // Remove qualquer tag adicionada
    ...
    // args -> conteudo antes ou depois do titulo: instace -> dados do form
    // Renderizar o conteudo na pagina
